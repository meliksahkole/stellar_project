...
const CONTRACT_ID = 'CONTRACT_ID_PLACEHOLDER' // Will be replaced with actual deployed contract ID
  ...
  const callPayHotel = async (
    ...
    try {
      ...
      if (result.successful) {
        ...
        // Call get_last_payment to retrieve the payment info
        const paymentInfo = await callGetLastPayment()
